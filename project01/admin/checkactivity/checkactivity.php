                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title">เช็คกิจกรรมพิเศษ</h1>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr align="center">
                                                ...
                                                <th scope="col"><input type="checkbox" onclick="toggle(this);" />Check all?<br /></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr align="center">
                                                ...
                                                <td><input type="checkbox" name="check[]" value="<?php echo $r['s_id']; ?>">
