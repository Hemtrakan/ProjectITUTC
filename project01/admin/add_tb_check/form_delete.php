                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title">ลบภาคเรียน / ปีการศึกษาในการเช็คแถว</h1>
                            ...
                            <form action="update.php?sc_id=<?php echo $_GET["sc_id"]; ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <br>
                                           <input type="text" class="form-control" value="<?php echo $r['term_name'] ?>" disabled>
                                    </div>

                                    <div class="col-md-4">
                                        <br>
                                        <input type="text" class="form-control" value="<?php echo $r['year_num'] ?>" disabled>
                                    </div>
